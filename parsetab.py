...
_lr_productions = [
  ...
  ('expression -> ID ASSIGN expression','expression',3,'p_expression','main.py',75),
  ...
  ('condition -> simple_expression LOGIC_OP simple_expression','condition',3,'p_condition','main.py',120),
